...
export declare function atomWithDefault<Value>(getDefault: Read<Value, [SetStateAction<Awaited<Value>> | typeof RESET], void>): WritableAtom<Value, [SetStateAction<Awaited<Value>> | typeof RESET], void>;
export {};
